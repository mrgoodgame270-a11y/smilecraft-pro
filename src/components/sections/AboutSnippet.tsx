      ...
      <div className="max-w-7xl mx-auto px-5 md:px-6 grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        <div className="relative grid grid-cols-2 gap-4">
          <div className="space-y-4 mt-10">
            <img
              ...
              className="rounded-3xl shadow-soft w-full h-56 md:h-64 object-cover"
              loading="lazy"
            />
          ...
          <div className="space-y-4">
            ...
            <img
              ...
              className="rounded-3xl shadow-soft w-full h-64 md:h-72 object-cover"
              loading="lazy"
            />
          </div>
        </div>
        ...
        >
          ...
          <h2 className="mt-3 font-display font-extrabold text-ink text-[clamp(1.75rem,4vw,3.25rem)] leading-[1.1]">
            Dedicated Professionals Delivering <span className="gradient-text">Personalized</span>{" "}
            Dental Excellence
          </h2>
          <p className="mt-5 text-slate-body text-[1rem] md:text-[1.0625rem] leading-[1.7]">
            For over 15 years we have combined gentle precision with modern technology so every
            visit feels effortless. From your first cleaning to a complete smile makeover, we treat
