          ...
          {DENTISTS.map((d, i) => (
            ...
            >
              <Link
                to="/dentists/$slug"
                params={{ slug: d.slug }}
                className="group block bg-cream rounded-3xl overflow-hidden shadow-soft hover:shadow-elevated transition-all"
              >
                <div className="relative aspect-[4/5] gradient-soft overflow-hidden">
                  ...
                  <div className="absolute top-3 right-3 flex gap-1.5">
                    <a
                      ...
                      className="w-9 h-9 rounded-full bg-cream/95 grid place-items-center shadow-soft hover:bg-primary hover:text-cream transition"
                      aria-label="LinkedIn"
                    >
                ...
                <div className="p-5">
                  ...
                  <span className="mt-3 inline-block text-primary font-semibold text-sm group-hover:translate-x-0.5 transition">
                    View profile →
                  </span>
                </div>
              </Link>
